...
```bash
git clone https://github.com/your-username/JustBidIt.git
cd JustBidIt
```
...
```python
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:YOUR_PASSWORD@localhost:3306/just_bid_it'
```
